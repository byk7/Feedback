...
@app.route('/')
def homepage(): 
    """Homepage. Redirect user to register."""
...
def register():
    """Show form to register/create a user.
...
def login():
    ...
    Handle form submission, ensuring the user is authenticated."""
...
def show_user(username):
    """Show page with user information for intended user."""
